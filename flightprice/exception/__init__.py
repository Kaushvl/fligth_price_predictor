...
class FlightPriceException(Exception):
    

    def __init__(self, error_message: Exception, error_detail:sys):
        super().__init__(error_message)
        self.error_message = FlightPriceException.error_message_detail(error_message, error_detail=error_detail)
    ...
    def __repr__(self):
        ...
        """
        return FlightPriceException.__name__.__str__()
